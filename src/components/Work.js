...
const workData = [
  {
    ...
    name: 'Pulsepredict',
    format: 'slider',
    project: 'blockchain prediction market platform',
    duration: '6 MONTHS',
    technologies: ['React', 'Next.js', 'Express', 'Solidity', 'Web3.js', 'mui', 'MySql'],
    budget: '35 USD/Hr',
    url: 'https://pulsepredict.io/',
    count: 4,
  },
  {
